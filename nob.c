...
int main(int argc, char **argv)
{
    ...
    nob_cmd_append(&cmd, "clang", "-std=c99", "-Wall", "-Wextra", "-Wpedantic", "-framework", "CoreVideo", "-framework", "IOKit", "-framework", "Cocoa", "-framework", "GLUT", "-framework", "OpenGL", "libraylib_x86.a", SRC_FOLDER"main.c", "-o", BUILD_FOLDER"/juego_en_el_tren");
#else
    // On MSVC
    nob_cmd_append(&cmd, "cl", "-std=c99", "-Wall", "-Wextra", "-Wpedantic", "-framework", "CoreVideo", "-framework", "IOKit", "-framework", "Cocoa", "-framework", "GLUT", "-framework", "OpenGL", "libraylib_x86.a", SRC_FOLDER"main.c", "-o", BUILD_FOLDER"/juego_en_el_tren");
#endif // _MSC_VER
